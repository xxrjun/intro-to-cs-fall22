...
void Inputrings(int x, int *x_linked_ring);                        // Get the input state of X-Linked Ring from user.
void Outputrings(int x, int *x_linked_ring);                       // Display entire X-Linked ring
...
void Outputrings(int counter, int x, int *x_linked_ring);                                         // helper function for Outputrings()
 ...
 * @param x_linked_ring
 */
void Inputrings(int x, int *x_linked_ring)
{
    int counter = 0;
 ...
 * @param x_linked_ring
 */
void Outputrings(int x, int *x_linked_ring)
{
    int counter = 0;
    while (counter < x)
    {
...
void S_rule(int end_idx, int *x_linked_ring, int *operation_info)
{
    ...
    /* Doing S_rule*/
    while (end_idx > 0 && x_linked_ring[end_idx] != 1)
    {
        end_idx--;
    }
